...
- **GitHub URL** 전부 반영 완료(카드 버튼용): OJO=`Gangto326/OJO`, 똑똑캡=`Gangto326/SmartCap`, MODA=`Gangto326/MODA`. LIDAR는 비공개라 링크 없음(버튼 자동 숨김).
...
## 대기 중(사용자에게 받을 것)
- ~~OJO / 똑똑캡 / MODA GitHub URL~~ **완료** — `Gangto326/OJO`·`Gangto326/SmartCap`·`Gangto326/MODA` 반영. LIDAR는 비공개(링크 없음).
