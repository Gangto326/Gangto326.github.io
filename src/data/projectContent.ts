  ...
  lidar: {
    ...
    troubleshooting: [
      {
        ...
        solution:
          '측정점을 **H3 육각 셀 단위로 사전 집계**(평균·최대·샘플 수)해 셀 요약 행만 저장하고, 요약 테이블은 월별 파티션으로 구성해 만료 월은 DELETE 대신 **파티션을 통째로 DROP**했습니다.',
        result:
    ...
    retrospective: [
      ...
      },
      {
        ...
        body: '셀 단위 사전 집계와 파티션 DROP으로 **저장을 아낀 결정**이, 데드튜플·VACUUM 부하 제거라는 **운영 안정성**으로 곧바로 이어진다는 것을 실측으로 확인했습니다.',
      },
      {
